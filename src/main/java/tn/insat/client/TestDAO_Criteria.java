...
import tn.insat.dao.ComptesRepositoryImplHibernateCriteria;
import tn.insat.dao.ComptesRepositoryImplHibernateHQL;
import tn.insat.entities.Compte;

public class TestDAO_Criteria 
{
	public static void main( String[] args )
    {
		 ComptesRepository repo = new ComptesRepositoryImplHibernateCriteria();
		//test_findAll(repo);
		 test_findById(repo);
		// test_create(repo);
		 test_count(repo);
